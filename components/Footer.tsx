    ...
    return (
        <footer>
            <div className="flex-col py-20 lg:flex ">
                    ...
                    <div>
                        ...
                        <div className="mb-8 mt-6 flex flex-row">
                            ...
                            <a
                                ...
                                className="text-black transition hover:text-gray-400 ml-4"
                            >
                                <svg
                                    className="fill-current"
                                    width="25"
                ...
                <div className="mx-auto my-6 w-full border border-[#E4E4E7] lg:my-12"></div>
                <div>
                    <p className="font-inter text-center text-sm text-gray-500 lg:">
